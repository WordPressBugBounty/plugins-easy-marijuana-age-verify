...
function emav_settings_callback_pagetargeting_option_field() {
	if(!function_exists('emav_premium_verify_option')){
	$selected_option = 'none'; ?>
	<fieldset>
	  	<legend class="screen-reader-text"><span><?php esc_html_e( 'Page Targeting', 'easy-marijuana-age-verify' ); ?></span></legend>
	  	<p>
			<label>
				<input disabled type="radio" name="_emav_pagetargeting_option[option]" value="none" <?php checked($selected_option, 'none'); ?> />
				<?php esc_html_e( 'Show on all pages (upgrade to unlock)', 'easy-marijuana-age-verify' ); ?>
			</label>
		</p><p>
			<label>
				<input disabled type="radio" name="_emav_pagetargeting_option[option]" value="include" <?php checked($selected_option, 'include'); ?> />
				<?php esc_html_e( 'Show on this page only (upgrade to unlock)', 'easy-marijuana-age-verify' ); ?>
			</label>
	  	</p><p>
			<label>
				<input disabled type="radio" name="_emav_pagetargeting_option[option]" value="exclude" <?php checked($selected_option, 'exclude'); ?> />
	...
	<?php
	 ...
	 echo emav_settings_callback_premium_pagetargeting_option_field();
 }
}
